...
export const setRoom = async (Data) => {
...
export const setNewGrupe = async (Data) => {
...
export const infoMsgTest = async (Data) => { console.log("inf"); socket.emit('info', "message testing works!"); }
...
export const dislikeMessage = async (Data) => {
    massges.findOne({ _id: Data.message._id }).then((msg) => {
        var likes = msg.likes ? msg.likes.indexOf(Data.user.result.email) : -1;
        var dislikes = msg.dislikes ? msg.dislikes.indexOf(Data.user.result.email) : -1;
